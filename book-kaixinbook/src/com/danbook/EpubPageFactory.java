...
public class EpubPageFactory {
    private static final String TAG = "EpubPageFactory";
    private File book_file = null;
    private final int m_backColor = 0xffff9e85; // 背景颜色
    ...
    private final String m_strCharsetName = "GBK";
    ...
    private final float mVisibleHeight; // 绘制内容的宽
    private final float mVisibleWidth; // 绘制内容的宽
    private final int mWidth;

    public EpubPageFactory(int w, int h) {
        mWidth = w;
        mHeight = h;
    ...
    /**
     * @param strFilePath
     * @param begin 表示书签记录的位置，读取书签时，将begin值给m_mbBufEnd，在读取nextpage，及成功读取到了书签 记录时将m_mbBufBegin开始位置作为书签记录
     * @throws IOException
     */
