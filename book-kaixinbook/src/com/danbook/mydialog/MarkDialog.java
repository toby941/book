...
import com.danbook.adapter.MarkAdapter;
...
public class MarkDialog extends Dialog implements OnItemClickListener {
    ...
    private final ArrayList<HashMap<String, String>> aList = null;
    ...
    public MarkDialog(Context context, ArrayList<MarkVo> list, Handler mHandler, int theme) {
        super(context, theme);
    ...
    public static void setAdapter(ListView markList, Context context, ArrayList<MarkVo> list) {
        if (list.size() == 0) {
            dialog.dismiss();
        }
        else {
